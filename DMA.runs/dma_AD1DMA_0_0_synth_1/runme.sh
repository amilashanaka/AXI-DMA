...
HD_PWD='C:/Projects/ERN24004/Projects/DMA/DMA.runs/dma_AD1DMA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_AD1DMA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_AD1DMA_0_0.tcl
